...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // On vérifie que TOUS les champs obligatoires sont bien là
    if (!empty($nom_equipe) && !empty($pseudo_chef) && !empty($email) && !empty($mdp) && !empty($id_session) && !empty($nom_chef) && !empty($prenom_chef)) {
        ...
        $message_erreur = "Veuillez remplir tous les champs obligatoires (incluant le nom, prénom et la date).";
    }
}
